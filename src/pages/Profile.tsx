    ...
    <div className="max-w-4xl mx-auto space-y-12">
      <div className="flex flex-col md:flex-row gap-8 items-center md:items-end">
         ...
         <div className="text-center md:text-left flex-1">
            <h2 className="text-4xl font-black mb-1">Aqua Linker</h2>
         ...
         <div className="flex gap-2">
            ...
            <button className="p-4 bg-white rounded-2xl border border-slate-100 shadow-sm text-slate-400 hover:text-slate-900 transition-colors">
               <LogOut size={20} />
            </button>
         </div>
      </div>
         ...
         <div className="space-y-8">
            ...
            <div className="space-y-4">
               {[
                 ...
                 { title: 'New Partner Near You', desc: 'Cong Caphe just joined the AquaLink network.', time: '1d ago' },
               ].map((n, i) => (
