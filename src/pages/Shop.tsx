...
const Shop = () => {
  ...
  const products = [
    { id: 1, name: 'AquaLink Metal - Midnight', price: 450000, desc: 'Premium stainless steel with laser engraving support.' },
    { id: 2, name: 'AquaLink Tritan - Crystal', price: 250000, desc: 'Eco-friendly BPA-free Tritan with charm slots.' },
    { id: 3, name: 'AquaLink Metal - Ocean', price: 450000, desc: 'Durable 500ml bottle for extreme environments.' },
  ];
    ...
    <div className="space-y-8">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-500 font-medium">Buy your customizable AquaLink bottle today.</p>
        </div>
      ...
      <AnimatePresence mode="wait">
        {step === 'browse' ? (
          ...
          >
             ...
             <p className="text-slate-500 font-medium mb-12">Thank you for joining the sustainable revolution. Your AquaLink bottle will be ready for customization soon.</p>
             <button
